...
const createScene = async function() {
    ...
    const faceUV = [];
    // the Vector points are (x, y, for bottom left and x,y for top right)
    ...
    const tree = BABYLON.SceneLoader.ImportMeshAsync("", "./meshes/", "low_poly_tree/Lowpoly_tree_sample.glb").then((result) => {

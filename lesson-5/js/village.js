...
const createScene = async function () {
    ...
    const cartMat = new BABYLON.StandardMaterial("carMat");
    ...
    const wheel1 = BABYLON.SceneLoader.ImportMeshAsync("", "./meshes/", "wheel11.glb").then((result) => {
        ...
        // position the wheel with respect to the center of cartMesh
